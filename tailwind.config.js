...
export default {
    ...
    theme: {
        extend: {
            colors: {
                'brand-dark':    '#0f172a', // slate blue body text
                'brand-primary': '#1d4ed8', // brand blue accent
                'brand-primary-2':'#0ea5e9', // gradient cyan
                'brand-accent':  '#f97316', // warm secondary CTA
                'brand-light':   '#f3f4f6', // soft background
            },
            fontFamily: {
